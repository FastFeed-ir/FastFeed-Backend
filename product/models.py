...
class Product(models.Model):
    ...
    discount_percentage = models.DecimalField(null=True, blank=True,max_digits=5, decimal_places=2, default=0.0, verbose_name="درصد تخفیف(اختیاری)")

    store = models.ForeignKey(Store, on_delete=models.CASCADE, blank=True, null=True, verbose_name="فروشگاه(به صورت خودکار افزوده میشود)")
